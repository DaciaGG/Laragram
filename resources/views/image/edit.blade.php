                ...
                <div class="card-body">
                    <form method="POST" action="{{route('image.update')}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="image_path" class="col-md-3 col-form-label text-md-rigth" >Imagen </label>
                            <div class='col-md-7'>
                                <div class="image-container image-detail image-edit">
                        ...
                        <div class="form-group row">
                            <label for="description" class="col-md-3 col-form-label text-md-rigth" >Descripcion de la imagen </label>
                            <div class='col-md-7'>
